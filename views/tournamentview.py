...
class TournamentView:
    ...
    def prompt_create_tournament(self):
        ...
        start_date = datetime.strptime(input("tournament start date in yyyy-mm-dd format : "), '%Y-%m-%d').strftime('%Y-%m-%d')
        end_date = datetime.strptime(input("tournament end date in yyyy-mm-dd format : "), '%Y-%m-%d').strftime('%Y-%m-%d')
